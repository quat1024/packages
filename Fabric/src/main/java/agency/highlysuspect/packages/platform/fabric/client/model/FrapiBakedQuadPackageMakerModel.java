...
public class FrapiBakedQuadPackageMakerModel extends AbstractPackageModel<List<BakedQuad>> {
	@Override
	protected PackageModelBakery.Factory<List<BakedQuad>> makeFactory() {
		return new BakedQuadPackageModelBakeryFactory(Packages.id("block/package_maker"));
	}
	...
	private static class Baked extends ForwardingBakedModel {
		...
		public void emitItemQuads(ItemStack stack, Supplier<Random> randomSupplier, RenderContext context) {
			...
			context.fallbackConsumer().accept(bakery.bake(null, null, null, null));
		}
	}
}
