...
public class DashPackageModelBakery {
	...
	@Serialize(order = 0) public final int baseModel;
	@Serialize(order = 1) public final int specialFrameSprite;
	@Serialize(order = 2) public final int specialInnerSprite;
