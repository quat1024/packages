...
public class PSoundEvents {
	...
	public static final SoundEvent INSERT_ONE = new SoundEvent(Init.id("insert_one"));
	public static final SoundEvent TAKE_ONE = new SoundEvent(Init.id("take_one"));
	public static final SoundEvent INSERT_STACK = new SoundEvent(Init.id("insert_stack"));
	public static final SoundEvent TAKE_STACK = new SoundEvent(Init.id("take_stack"));
	public static final SoundEvent INSERT_ALL = new SoundEvent(Init.id("insert_all"));
	public static final SoundEvent TAKE_ALL = new SoundEvent(Init.id("take_all"));
